...
6. Generate release notes from commits + changed files
7. Ensure GitHub Release for `v<version>` exists
8. Upload generated `RELEASE_NOTES.md` as release asset
...
This repository is already configured with those rules.
